...
export default function MedecinLayout({
  ...
  return (
    <div className="flex min-h-screen w-full bg-zinc-950 text-zinc-50 selection:bg-emerald-400/30">
      {/* ==================== Sidebar (Desktop) ==================== */}
      <aside className="fixed top-0 left-0 z-30 hidden lg:flex w-64 h-screen flex-col bg-gradient-to-b from-zinc-950 via-zinc-950 to-zinc-900/50 ring-1 ring-white/[0.06] overflow-hidden">
        <div
          aria-hidden
        ...
        <Link href="/" className="flex items-center gap-2.5 px-5 py-5 border-b border-white/[0.06]">
      ...
      <motion.main
        ...
        className="flex-1 lg:ml-64 mt-14 lg:mt-0 overflow-x-hidden"
      >
        {children}
      </motion.main>
    </div>
